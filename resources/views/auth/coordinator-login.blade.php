...
@section('title', 'Coordinator Login - Internship Tracking System')
    ...
    <div class="row justify-content-center align-items-center" style="min-height: 85vh;">
        <div class="col-md-5 col-lg-4">
            ...
            <div class="text-center mb-4">
                ...
                <h4 class="text-white fw-bold mb-1">Coordinator Login</h4>
                <p class="text-white-50 mb-0" style="font-size: 0.875rem;">Sign in to your coordinator account</p>
            </div>
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('coordinator.login') }}">
                        ...
                        <button type="submit" class="btn w-100 text-white fw-semibold"
                            ...
                            <i class="bi bi-arrow-right-circle me-1"></i>Sign In as Coordinator
                        </button>
                    </form>
                </div>
            </div>
            ...
            <div class="text-center mt-3">
                <p class="text-white-50 mb-0" style="font-size: 0.8125rem;">
                    New coordinator? <a href="{{ route('coordinator.register') }}" class="text-decoration-none" style="color: #6ee7b7; font-weight: 500;">Create an account</a>
                </p>
            </div>
