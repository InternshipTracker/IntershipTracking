        ...
        <form wire:submit="authenticate" class="mt-6 space-y-4">
            ...
            <div>
                ...
                <div class="flex items-center gap-3 rounded-full bg-[#f2efed] px-4 py-3 text-[#a49486] shadow-inner border border-[#ece3dc]">
                    ...
                    <button type="button" class="shrink-0 text-xs font-semibold text-[#8a7d70] hover:text-[#6c6259]" onclick="const i=this.parentElement.querySelector('input[type=password],input[type=text]'); const s=i.type==='password'; i.type=s?'text':'password'; this.textContent=s?'Hide':'Show';">Show</button>
                </div>
